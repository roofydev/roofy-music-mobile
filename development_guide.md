# Roofy Music Dev Guide

This file outlines the process of setting up a local dev environment for Roofy Music.
...
```bash
git clone https://github.com/Roofy MusicGroup/Roofy Music
cd Roofy Music
