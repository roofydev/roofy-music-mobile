...
class DiscordRPC(
    ...
    suspend fun updateSong(
        ...
        if (button2Visible) {
            val resolvedText = resolveVariables(
                button2Text.ifEmpty { "Visit Roofy Music" },
                song,
            )
            buttonsList.add(Button(resolvedText, "https://github.com/IvanLuqueSoft/roofy-music-mobile"))
        }
    ...
    companion object {
        // TODO: Create your own Discord app at https://discord.com/developers/applications named "Roofy Music",
        // then replace this APPLICATION_ID with your new app's ID. Changing without a matching app will break Rich Presence.
        private const val APPLICATION_ID = "1506223227800649818"
