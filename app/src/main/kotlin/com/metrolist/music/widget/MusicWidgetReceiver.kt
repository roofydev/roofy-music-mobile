...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "app.roofymusic.mobile.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "app.roofymusic.mobile.widget.LIKE"
        const val ACTION_NEXT = "app.roofymusic.mobile.widget.NEXT"
        const val ACTION_PREVIOUS = "app.roofymusic.mobile.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "app.roofymusic.mobile.widget.UPDATE_WIDGET"
    }
}
