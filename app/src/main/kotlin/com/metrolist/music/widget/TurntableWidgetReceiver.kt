...
class TurntableWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_TURNTABLE_PLAY_PAUSE = "app.roofymusic.mobile.widget.TURNTABLE_PLAY_PAUSE"
        const val ACTION_TURNTABLE_NEXT = "app.roofymusic.mobile.widget.TURNTABLE_NEXT"
        const val ACTION_TURNTABLE_PREVIOUS = "app.roofymusic.mobile.widget.TURNTABLE_PREVIOUS"
        const val ACTION_UPDATE_TURNTABLE_WIDGET = "app.roofymusic.mobile.widget.UPDATE_TURNTABLE_WIDGET"
    }
}
