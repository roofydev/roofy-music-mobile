...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "app.roofymusic.mobile.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "app.roofymusic.mobile.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "app.roofymusic.mobile.widget.recognizer.RESET"
    }
}
