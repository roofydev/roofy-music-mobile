...
class PlaylistWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        ...
        const val ACTION_PLAY_TARGET = "app.roofymusic.mobile.widget.playlists.PLAY_TARGET"
        const val ACTION_UPDATE_WIDGET = "app.roofymusic.mobile.widget.playlists.UPDATE_WIDGET"
