...
fun OnlineSearchResult(
    ...
    val ytItemContent: @Composable LazyItemScope.(YTItem, Int) -> Unit = { item: YTItem, index: Int ->
        val longClick = {
        ...
        OutlinedTextField(
            ...
            colors =
                OutlinedTextFieldDefaults.colors(
                    focusedTextColor = RetroTokens.TextHot,
                    unfocusedTextColor = RetroTokens.Text,
                    focusedContainerColor = RetroTokens.Background,
                    unfocusedContainerColor = RetroTokens.Background,
                    cursorColor = RetroTokens.BorderBright,
                    focusedBorderColor = RetroTokens.BorderBright,
                    unfocusedBorderColor = RetroTokens.Border,
                ),
            modifier =
                Modifier
                    .fillMaxWidth()
                    ...
                    if (searchFilter == null) {
                        searchSummary?.summaries?.forEach { summary ->
                            ...
                            items(
                                ...
                                ytItemContent(item, summary.items.indexOf(item))
                            }
                        }
                        ...
                        items(
                            ...
                            ytItemContent(item, itemsPage?.items?.indexOf(item) ?: 0)
                        }
